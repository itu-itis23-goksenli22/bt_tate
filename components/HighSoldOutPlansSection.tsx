...
export default function HighSoldOutPlansSection() {
  return (
          ...
          <div className="relative card-trw border-accent/50 hover:border-accent transition-all">
            ...
            <div className="absolute -top-3 left-1/2 -translate-x-1/2">
              <div className="bg-danger px-4 py-1 rounded-full shadow-lg">
                <span className="text-white text-xs font-bold uppercase">%50 İNDİRİM</span>
              </div>
            </div>
            <div className="text-center py-8 pt-12">
              <h3 className="text-2xl font-bold text-accent mb-2">FETİH PLANI</h3>
              <p className="text-white/60 text-sm mb-4 uppercase tracking-wider">Elit Erişim - Premium</p>
              <div className="flex items-center justify-center gap-3 mb-4">
                <span className="text-2xl font-bold text-white/40 line-through">₺30,000</span>
                <span className="text-5xl font-bold text-accent">₺15,000</span>
              </div>
              <p className="text-white/60 text-sm mb-6">Tek seferlik ödeme</p>
