const bonuses = [
  ...
  {
    title: "AI ile E-Ticaret Araçları Kiti",
    value: "$150",
    description:
      "ChatGPT ile ürün açıklaması yazma, fiyat analizi ve rakip araştırma için hazırlanmış kapsamlı araç rehberi.",
  },
  {
    title: "Shopify Mağaza Kurulum Şablonları",
    value: "$100",
    description:
      "Hazır mağaza şablonları, ürün sayfası tasarımları ve dönüşüm odaklı checkout optimizasyonu rehberi.",
  },
  {
    title: "E-Ticaret Sosyal Medya Takvimi",
    value: "$80",
    description:
      "30 günlük hazır içerik planı, ürün tanıtım formülleri ve AI ile e-ticaret içerik üretme workflow'u.",
  },
  {
    title: "Özel Discord Topluluğu Erişimi",
    value: "$50",
    description:
      "Diğer e-ticaret girişimcileriyle networking yapın, sorularınızı sorun ve birlikte büyüyün.",
  },
];
