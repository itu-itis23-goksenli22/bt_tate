      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="section-title">
            ÖNÜNÜZDE <span className="text-gold">İKİ YOL VAR</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          {/* Path 2 - With */}
          <div className="card-glass border-2 border-gold/50 hover:border-gold transition-all">
            <div className="text-center mb-6">
              <div className="inline-block px-4 py-2 bg-gold/20 border border-gold rounded-full mb-4">
                <span className="text-gold font-bold uppercase text-sm">Gerçek Dünya</span>
              </div>
            </div>

            {/* Image placeholder */}
            <div className="relative aspect-video bg-primary-dark rounded-lg overflow-hidden mb-6 border border-gold/20">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gold/20 to-primary-dark">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-3 bg-gold/20 rounded-lg flex items-center justify-center border border-gold">
        ...
        <div className="text-center">
          <p className="text-2xl text-white/70 mb-4">
            ...
            <span className="text-gold font-bold"> yarın için çok geç olabilir.</span>
          </p>
        </div>
      </div>
    </section>
