...
export default function HighPricingSection() {
  const packageInfo = {
    name: "FETIH PLANI",
        ...
        <div id="pricing-card" className="max-w-2xl mx-auto">
          <div className="relative rounded-2xl p-8 md:p-10 transition-all duration-300 bg-gradient-to-b from-accent/10 to-primary-light border-2 border-accent shadow-2xl shadow-glow">
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-gradient-to-r from-gold via-gold-light to-gold px-6 py-2 rounded-full shadow-lg">
                <span className="text-black font-bold text-sm uppercase tracking-wider">⭐ PREMIUM PAKETİ ⭐</span>
              </div>
            </div>
