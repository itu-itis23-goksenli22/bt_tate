...
export default function EticaretIbanSection() {
      ...
      <div className="max-w-2xl mx-auto px-4 text-center">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
          ...
          <div className="bg-black/30 rounded-xl p-4 md:p-5 mb-4 text-left space-y-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1">
              <span className="text-white/50 text-sm min-w-[80px]">Ad Soyad:</span>
              <span className="text-white font-semibold text-sm md:text-base">Baturalp Tunalı</span>
            </div>
            <div className="flex flex-col sm:flex-row sm:items-center gap-1">
              <span className="text-white/50 text-sm min-w-[80px]">Tutar:</span>
              <span className="text-gold font-bold text-sm md:text-base">₺9,900</span>
            </div>
          </div>

          <p className="text-white/50 text-xs md:text-sm mb-4">
            Açıklamaya{" "}
            <span className="text-white font-semibold">adınızı ve telefon numaranızı</span>{" "}
            yazın, size hemen ulaşalım.
          </p>

          <a
            href="https://wa.me/12084509523?text=Merhaba%2C%20e-ticaret%20e%C4%9Fitimi%20i%C3%A7in%20havale%20ile%20%C3%B6deme%20yapmak%20istiyorum."
            target="_blank"
