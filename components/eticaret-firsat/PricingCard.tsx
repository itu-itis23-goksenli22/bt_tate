        ...
        <div className="space-y-2 text-left">
          <div className="flex items-start gap-2">
            ...
            <p className="text-white/70 text-xs leading-relaxed">
              E-Ticaret & Dropshipping eğitim programı + topluluk erişimi
            </p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gold text-sm flex-shrink-0">✦</span>
            <p className="text-white/70 text-xs leading-relaxed">
              Amazon FBA + ETSY + Shopify eğitimleri + canlı mentörlük
            </p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gold text-sm flex-shrink-0">✦</span>
            <p className="text-white/70 text-xs leading-relaxed">
              AI ile e-ticaret otomasyonu + Ads stratejisi + ürün araştırma
            </p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-gold text-sm flex-shrink-0">✦</span>
