  ...
  return (
    <section className="py-12 px-4 bg-primary relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-0 w-64 h-64 bg-accent rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-accent rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
              ÇEVRİMİÇİ YOLCULUĞUNUZA <span className="text-accent">HIZLI BAŞLANGIÇ</span>
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="w-8 h-8 bg-accent/20 rounded-lg flex items-center justify-center border border-accent/50 mr-4 flex-shrink-0">
          ...
          <div className="relative aspect-square bg-primary-light rounded-xl overflow-hidden border border-white/10">
            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-primary-light to-primary">
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-4 bg-accent/20 rounded-lg flex items-center justify-center border border-accent/50">
