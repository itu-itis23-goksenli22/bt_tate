...
export default function EticaretOdemeonayContent() {
  useEffect(() => {
    // Browser pixel — Purchase event (dijitalakademi.live = 9900 TRY)
    trackPurchase({ value: 9900, currency: "TRY" });
    ...
    fetch("/api/meta-capi", {
      ...
      body: JSON.stringify({
        ...
        customData: { value: 9900, currency: "TRY" },
      }),
    }).catch(() => {});
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {"Dijital Akademi ailesine ho\u015F geldiniz! \uD83D\uDE80"}
        </p>
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: "16px", marginBottom: "16px" }}>
            ...
            <div>
              ...
              <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "14px", marginBottom: "12px", lineHeight: 1.6 }}>
                {"Size \u00F6zel olarak haz\u0131rlad\u0131\u011F\u0131m\u0131z E-Ticaret H\u0131zl\u0131 Ba\u015Flang\u0131\u00E7 Paketi'ni hemen indirin ve e-ticaret d\u00FCnyas\u0131na ad\u0131m at\u0131n!"}
              </p>
          ...
          >
            {"\uD83D\uDD11 E-Ticaret Ba\u015Flang\u0131\u00E7 Paketini Al \u2192"}
          </a>
        </div>

        {/* WhatsApp Button */}
        <a
          href="https://wa.me/12084509523?text=Merhaba%2C%20e-ticaret%20e%C4%9Fitimi%20i%C3%A7in%20%C3%B6deme%20yapt%C4%B1m%2C%20bilgi%20almak%20istiyorum."
          target="_blank"
          rel="noopener noreferrer"
          style={{
            display: "flex",
        ...
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "14px", textAlign: "center" }}>
          {"Dijital Akademi ile ba\u015Far\u0131ya giden yolculu\u011Funuz ba\u015Flad\u0131 \uD83D\uDE80"}
        </p>
      </div>
