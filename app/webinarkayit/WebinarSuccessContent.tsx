      ...
      <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 px-4">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            ...
            <span className="text-accent block mt-2">{name}!</span>
          </h1>
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <div className="card-glass p-8 border-accent/40">
              <div className="mb-6">
              ...
              >
                <button className="btn-primary text-lg px-12 py-4 shadow-glow-strong hover:shadow-glow-hover w-full">
                  Bonus Paketi İndir →
                </button>
              </a>
            </div>
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-24 h-24 rounded-full bg-accent/20 border-2 border-accent/40 flex items-center justify-center hover:bg-accent/30 hover:scale-110 transition-all"
            >
