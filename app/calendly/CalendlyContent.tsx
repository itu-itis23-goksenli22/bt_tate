...
// büyük butonla Calendly'yi yeni sekmede açıp onboarding görüşmesi
// rezerve eder.
//
// NOT: Inline embed kaldırıldı. Calendly iframe embed bazı
// tarayıcılarda (Safari Cross-Site Tracking, content blocker) "içerik
// engellendi" gösteriyordu — Calendly'nin kendi dokümanı da bu durumda
// fallback buton öneriyor. Bu yüzden direkt buton: yeni sekmede
// Calendly açar (first-party = hiçbir engel yok, her tarayıcıda %100
// çalışır).
...
// WhatsApp — randevu alamayan kullanıcı için DESTEK kanalı (randevu
// alma aracı değil). Ön-dolu mesaj: onboarding görüşmesi için takvimden
// randevu alamadığını belirtir.
const WHATSAPP_URL =
  "https://wa.me/12084509523?text=Merhaba%2C%20onboarding%20g%C3%B6r%C3%BC%C5%9Fmesi%20i%C3%A7in%20takvimden%20randevu%20alamad%C4%B1m%2C%20yard%C4%B1mc%C4%B1%20olur%20musunuz%3F";
...
export default function CalendlyContent() {
  return (
    ...
    >
      ...
      {/* 2. BÜYÜK CALENDLY BUTONU — yeni sekmede Calendly açar */}
      <a
        href={CALENDLY_URL}
        target="_blank"
        ...
        style={{
          ...
          textDecoration: "none",
          marginBottom: "10px",
          boxShadow: `0 10px 40px ${GOLD_BG} 0.4)`,
          lineHeight: 1.3,
        }}
      >
        📅 Takvimi Aç ve Onboarding Görüşmeni Al →
      </a>
      <p
        style={{
      ...
      {/* 3. WHATSAPP — randevu ALMA değil DESTEK kanalı.
          Takvimden randevu alamayan kullanıcı buradan ulaşır. */}
      <a
        href={WHATSAPP_URL}
        target="_blank"
        rel="noopener noreferrer"
      ...
      >
        ...
        Randevu alamadıysan WhatsApp&apos;tan bize ulaşabilirsin
      </a>

      {/* 4. ONBOARDING'DE NELER OLACAK — 4 değer maddesi */}
      <div
        style={{
          width: "100%",
          maxWidth: "640px",
