...
export const metadata: Metadata = {
  ...
  description:
    "Her Pazar 20:00'da canlı ücretsiz AI webinarına katılın. Yapay zeka ile online para kazanmanın kanıtlanmış yollarını öğrenin. Sınırlı kontenjan!",
  openGraph: {
...
export default function ZoomKayitPage() {
  return (
